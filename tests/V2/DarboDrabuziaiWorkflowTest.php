...
class DarboDrabuziaiWorkflowTest extends TestCase
{
    ...
    public function testFullWorkflowSimulation(): void
    {
        ...
        $mockResponses = [
            ...
            [
                ...
                'failed_operations' => 0,
                'results' => [
                    ['id' => 'prod-1', 'operation' => 'index_products', 'status' => 'created'], ['id' => 'prod-2', 'operation' => 'index_products', 'status' => 'created'],
                ],
            ],
            ...
            [
                ...
                'failed_operations' => 0,
                'results' => [
                    ['id' => 'prod-1', 'operation' => 'index_products', 'status' => 'created'], ['id' => 'prod-2', 'operation' => 'index_products', 'status' => 'created'], ['id' => 'prod-3', 'operation' => 'index_products', 'status' => 'created'],
                ],
            ],
    ...
    {
        $mockResponses = [['status' => 'success', 'total_operations' => 1, 'successful_operations' => 1, 'failed_operations' => 0, 'results' => [['id' => 'prod-1', 'operation' => 'index_products', 'status' => 'created'], ['id' => 'prod-2', 'operation' => 'index_products', 'status' => 'created'], ['id' => 'prod-3', 'operation' => 'index_products', 'status' => 'created']]]];
        $sdk = $this->createSdkWithRequestCapture($mockResponses);
