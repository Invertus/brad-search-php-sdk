...
class QueryConfigurationRequestBuilderTest extends TestCase
{
    public function testBuildCreatesQueryConfigurationRequest(): void
    {
        ...
        $request = $builder
            ->addSearchField(new SearchFieldConfig('name', 1))
            ->build();
    ...
    public function testFluentApiReturnsBuilder(): void
    {
        ...
        $this->assertSame($builder, $builder->addSearchField(new SearchFieldConfig('name', 1)));
    ...
    public function testBuildWithMultipleSearchFields(): void
    {
        ...
        $request = $builder
            ->addSearchField(new SearchFieldConfig('name', 1))
            ->addSearchField(new SearchFieldConfig('description', 2))
            ->addSearchField(new SearchFieldConfig('sku', 3))
            ->build();
    ...
    public function testCanReuseBuilderAfterReset(): void
    {
        ...
        $request2 = $builder
            ->addSearchField(new SearchFieldConfig('title', 1))
            ->multiWordOperator(MultiWordOperator::OR)
            ->build();
    ...
    public function testBuilderCanBuildMultipleRequestsSequentially(): void
    {
        ...
        $this->assertNull($request1->popularityBoost);
    ...
    public function testOrderOfSearchFieldsIsPreserved(): void
    {
        ...
        $request = $builder
            ->addSearchField(new SearchFieldConfig('sku', 1))
            ->addSearchField(new SearchFieldConfig('name', 2))
            ->addSearchField(new SearchFieldConfig('description', 3))
            ->build();
    ...
    public function testBuildingAdvancedConfigurationWithBuilder(): void
    {
        ...
        $request = $builder
            ->addSearchField(new SearchFieldConfig('name_lt-LT', 1, MatchMode::PHRASE_PREFIX))
            ->addSearchField(new SearchFieldConfig('brand_lt-LT', 2, MatchMode::FUZZY))
            ->addSearchField(new SearchFieldConfig('description_lt-LT', 3, MatchMode::FUZZY))
            ->addSearchField(new SearchFieldConfig('sku', 4, MatchMode::EXACT))
